 ...
 * @author Benoit
 */
public class CtrlFlagQuiz implements WindowListener, ActionListener, KeyListener {
    ...
    private Timer timer;
    private CtrlFlagQuiz capitalQuiz = this;
    ...
    public CtrlFlagQuiz(VueCapitalQuiz vue, CtrlPrincipal ctrl, int mode, int difficulty) {
        this.vue = vue;
        ...
        try {
            ...
            Logger.getLogger(CtrlFlagQuiz.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            rightClip.open(AudioSystem.getAudioInputStream(CtrlFlagQuiz.class.getResource("/sounds/" + "right.wav")));
            wrongClip.open(AudioSystem.getAudioInputStream(CtrlFlagQuiz.class.getResource("/sounds/" + "wrong.wav")));
            timeOutClip.open(AudioSystem.getAudioInputStream(CtrlFlagQuiz.class.getResource("/sounds/" + "timeOut.wav")));
            clockClip.open(AudioSystem.getAudioInputStream(CtrlFlagQuiz.class.getResource("/sounds/" + "clock.wav")));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    AudioInputStream inputStream = AudioSystem.getAudioInputStream(CtrlFlagQuiz.class.getResource("/sounds/" + url));
